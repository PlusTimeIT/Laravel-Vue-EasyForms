...
import { I as m, T as G } from "./Icon-DH81jwGa.js";
import { a as w, c as f, d as b, i as c, e as E, f as U, g as L, P as Y, s as J } from "./Store-RDttjRLY.js";
import { M as q } from "./Menu-Brabma8c.js";
import { c as o, a as A, g as Z, S as $ } from "./ServerCall-BFyGF5P4.js";
import { A as K } from "./ContentTypes-DALGF8cl.js";
import { D as Q } from "./ScrollStrategyTypes-E4DrddYC.js";
import { G as X } from "./GotProps-DcRlB6g3.js";
const n = class n {
};
...
class B {
  static exists(r) {
    return typeof P[r] < "u" ? !0 : A(r) in j;
  }
  ...
  static getName(r) {
    if (this.exists(r.name))
      return A(r.name) in j ? j[A(r.name)] : r.name;
  }
}
const h = class h {
...
class ue extends u {
  ...
  addAllItems() {
    ...
    for (const t of this.items)
      t.value = !0, this.value.push(new O({ key: t.name, value: t.value }));
  }
  addItem(t, s) {
    this.value.push(new O({ key: t, value: s }));
  }
  /**
   * Returns an array of all allowed props that are present on V-Checkbox
   * https://vuetifyjs.com/en/api/v-checkbox/
