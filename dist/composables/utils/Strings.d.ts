...
declare const kebabToPascal: (o: string) => string;
...
export { snakeToCamel, snakeToKebab, kebabToSnake, kebabToPascal, capitalizeFirst, capitalizeEach, generate, convertMessageHolders, };
