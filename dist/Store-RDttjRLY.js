...
class s {
  ...
  static isEmpty(t) {
    return t == null ? !0 : Array.isArray(t) ? t.length === 0 : typeof t == "object" ? Object.keys(t).length === 0 && t.constructor === Object : typeof t == "string" ? !t.length : typeof t == "number" ? (console.log("o", t, typeof t, typeof t == "number", t <= 0, isNaN(t)), t < 0 || isNaN(t)) : !1;
  }
  /**
...
const h = (e) => s.isArray(e), m = (e) => s.isObject(e), g = (e) => s.isFile(e), x = (e) => s.isString(e), N = (e) => s.isNumber(e), j = (e) => s.isNumeric(e), A = (e) => s.isNull(e), b = (e) => s.isEmpty(e), a = class a {
  constructor(t) {
    /**
