...
const Comp3 = { "title": "Installation", "icon": "carbon:bookmark", "group": "getting-started", "docsOnly": true, "variants": [] };
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView.vue-783bfe7d.js"), true ? ["./HomeView.vue-783bfe7d.js","./vendor-b18d341b.js"] : void 0, import.meta.url)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import("./StoryView.vue-545e697d.js"), true ? ["./StoryView.vue-545e697d.js","./vendor-b18d341b.js","./MobileOverlay.vue2-cf178ece.js","./BaseEmpty.vue-d9786662.js","./state-c26ea4ce.js"] : void 0, import.meta.url)
    }
  ]
});
