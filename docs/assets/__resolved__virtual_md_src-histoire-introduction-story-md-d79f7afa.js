...
<p>This documentation is only for this plugins version greater than <code>0.4.11-beta</code> and with the parent plugin <a href="https://packagist.org/packages/plustime-it/laravel-easyforms" target="_blank">Laravel EasyForms <code>0.2.0@beta</code></a> ( due to moving to Vue3 and Typescript ). You must also set your vuetify version to be greater than <code>Vuetify 3.3.7</code>.</p>
