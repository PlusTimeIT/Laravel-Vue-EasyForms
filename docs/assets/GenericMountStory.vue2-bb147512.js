...
const Comp1 = { "title": "Installation", "icon": "carbon:bookmark", "group": "getting-started", "docsOnly": true, "variants": [] };
const Comp2 = { "title": "Form Basics", "icon": "carbon:bookmark", "group": "forms", "docsOnly": true, "variants": [] };
const Comp3 = { "title": "Intro", "icon": "carbon:bookmark", "group": "top", "docsOnly": true, "variants": [] };
const Comp0 = defineAsyncComponent(() => __vitePreload(() => import("./FormLoader.story-09273966.js"), true ? ["./FormLoader.story-09273966.js","./vendor-ab3d704c.js"] : void 0, import.meta.url));
const Comp4 = defineAsyncComponent(() => __vitePreload(() => import("./vendor-ab3d704c.js").then((n) => n.aG), true ? [] : void 0, import.meta.url));
let files = [
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView.vue-a4d1e63f.js"), true ? ["./HomeView.vue-a4d1e63f.js","./vendor-ab3d704c.js"] : void 0, import.meta.url)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import("./StoryView.vue-99be7426.js"), true ? ["./StoryView.vue-99be7426.js","./vendor-ab3d704c.js","./MobileOverlay.vue2-6cd59d68.js","./BaseEmpty.vue-e30463d5.js","./state-045ae238.js"] : void 0, import.meta.url)
    }
  ]
});
...
const clientSupportPlugins = {
  "vanilla": () => __vitePreload(() => import("./vendor-ab3d704c.js").then((n) => n.aH), true ? [] : void 0, import.meta.url),
  "vue3": () => __vitePreload(() => import("./vendor-ab3d704c.js").then((n) => n.aI), true ? [] : void 0, import.meta.url)
};
const __default__ = {
  inheritAttrs: false
};
