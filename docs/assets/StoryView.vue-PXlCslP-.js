...
const markdownFiles = reactive({ "src/docs/FormBasics.story.md": () => __vitePreload(() => import('./__resolved__virtual_md_src-docs-formbasics-story-md-CzliFs2X.js'),true?__vite__mapDeps([]):void 0,import.meta.url), "src/docs/Installation.story.md": () => __vitePreload(() => import('./__resolved__virtual_md_src-docs-installation-story-md-CSdbD1GL.js'),true?__vite__mapDeps([]):void 0,import.meta.url), "src/docs/Introduction.story.md": () => __vitePreload(() => import('./__resolved__virtual_md_src-docs-introduction-story-md-CY1UOZsL.js'),true?__vite__mapDeps([]):void 0,import.meta.url) });
