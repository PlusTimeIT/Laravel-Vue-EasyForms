...
const Comp0 = defineAsyncComponent(() => __vitePreload(() => import('./FormLoader.story-CltHJi5t.js'),true?__vite__mapDeps([0,1]):void 0,import.meta.url));
const Comp4 = defineAsyncComponent(() => __vitePreload(() => import('./vendor-DLEny9de.js').then(n => n.a_),true?__vite__mapDeps([]):void 0,import.meta.url));
let files = [
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import('./HomeView.vue-IzOXSKi5.js'),true?__vite__mapDeps([2,3,1]):void 0,import.meta.url)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import('./StoryView.vue-DIeFE7Cz.js'),true?__vite__mapDeps([4,1,3,5,6,7]):void 0,import.meta.url)
    }
  ]
});
...
const clientSupportPlugins = {
    'vanilla': () => __vitePreload(() => import('./vendor-DLEny9de.js').then(n => n.a$),true?__vite__mapDeps([]):void 0,import.meta.url),
  'vue3': () => __vitePreload(() => import('./vendor-DLEny9de.js').then(n => n.b0),true?__vite__mapDeps([]):void 0,import.meta.url)
  };
...
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["./FormLoader.story-CltHJi5t.js","./vendor-DLEny9de.js","./HomeView.vue-IzOXSKi5.js","./story-B3YmE3qn.js","./StoryView.vue-DIeFE7Cz.js","./MobileOverlay.vue2-C0aTgL3O.js","./BaseEmpty.vue-Dnq9KqNh.js","./state-QuQfA4u4.js"]
  }
