...
const Comp0 = defineAsyncComponent(() => __vitePreload(() => import("./FormLoader.story-ac2824dc.js"), true ? ["./FormLoader.story-ac2824dc.js","./vendor-3d7bd4d3.js"] : void 0, import.meta.url));
const Comp4 = defineAsyncComponent(() => __vitePreload(() => import("./vendor-3d7bd4d3.js").then((n) => n.aI), true ? [] : void 0, import.meta.url));
let files = [
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView.vue-294fa0d8.js"), true ? ["./HomeView.vue-294fa0d8.js","./story-f57eb34a.js","./vendor-3d7bd4d3.js"] : void 0, import.meta.url)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import("./StoryView.vue-d05fccb2.js"), true ? ["./StoryView.vue-d05fccb2.js","./vendor-3d7bd4d3.js","./story-f57eb34a.js","./MobileOverlay.vue2-f62beae9.js","./BaseEmpty.vue-e0cdd273.js","./state-8b62c49a.js"] : void 0, import.meta.url)
    }
  ]
});
...
const clientSupportPlugins = {
  "vanilla": () => __vitePreload(() => import("./vendor-3d7bd4d3.js").then((n) => n.aJ), true ? [] : void 0, import.meta.url),
  "vue3": () => __vitePreload(() => import("./vendor-3d7bd4d3.js").then((n) => n.aK), true ? [] : void 0, import.meta.url)
};
const __default__ = {
  inheritAttrs: false
};
